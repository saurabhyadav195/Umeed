...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-j=@5sym*k^_(!#u==3^@t%)xjeo#5blq%vn8#m3z!lyb0+-r+0')
...
CSRF_TRUSTED_ORIGINS = ['https://*.trycloudflare.com', 'https://*.render.com']
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgres://postgres:1905@localhost:5432/umeed'),
        conn_max_age=600
    )
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'umeeddonation@gmail.com')
